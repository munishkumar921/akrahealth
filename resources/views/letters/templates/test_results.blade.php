...
<head>
    ...
    <style>
        ...
        .header { text-align: center; border-bottom: 3px solid #9b59b6; padding-bottom: 20px; margin-bottom: 30px; }
        .hospital-name { font-size: 18pt; font-weight: bold; color: #2c3e50; margin-bottom: 5px; }
        .hospital-address { font-size: 10pt; color: #666; }
        .letter-type { text-align: center; font-size: 16pt; font-weight: bold; color: #9b59b6; margin-bottom: 30px; text-transform: uppercase; letter-spacing: 2px; }
        .date { text-align: right; margin-bottom: 20px; }
        .patient-info { background-color: #faf5fc; padding: 15px; border-radius: 5px; margin-bottom: 20px; border-left: 4px solid #9b59b6; }
        ...
        .results-box { background-color: #f8f9fa; padding: 20px; border-radius: 5px; margin: 20px 0; }
        .normal-range { color: #27ae60; font-weight: bold; }
        .abnormal-range { color: #e74c3c; font-weight: bold; }
...
<body>
    ...
    <div style="text-align: center;"><div class="letter-type">TEST RESULTS LETTER</div></div>
    ...
    <div class="results-box"><strong style="color: #9b59b6;">TEST RESULTS SUMMARY:</strong><br>{{ $body }}</div>
    ...
    <div class="footer"><div style="text-align: center; font-size: 9pt; color: #999;">Please consult your physician to discuss these results in detail.</div></div>
</body>
</html>
