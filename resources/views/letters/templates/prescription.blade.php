...
<head>
    ...
    <style>
        ...
        .letter-type { text-align: center; font-size: 16pt; font-weight: bold; color: #e74c3c; margin-bottom: 30px; text-transform: uppercase; letter-spacing: 2px; }
        ...
        .rx-symbol { font-size: 48pt; color: #e74c3c; font-weight: bold; text-align: center; margin: 20px 0; }
        ...
        .warning-box { background-color: #fff3cd; border: 2px solid #f39c12; padding: 15px; margin: 20px 0; border-radius: 5px; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div style="text-align: center;"><div class="letter-type">PRESCRIPTION LETTER</div></div>
    ...
    @endif
    <div><div><strong>Rx:</strong> {{ $to }}</div></div>
    <div class="subject"><strong>Subject:</strong> {{ $subject }}</div>
    <div class="body-content">{{ $body }}</div>
    <div class="warning-box"><strong style="color: #f39c12;">⚠️ IMPORTANT:</strong> This prescription is valid for 30 days. Please follow dosage instructions carefully.</div>
    ...
    <div class="footer"><div style="text-align: center; font-size: 9pt; color: #999;">This prescription requires pharmacist verification.</div></div>
</body>
</html>
