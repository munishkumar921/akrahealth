...
import { doctorNavItems } from "../../Data/MenuItems";
...
const page = usePage();
const counts = page.props.value?.counts || page.props.value?.doctorCounts || page.props.value?.patientCounts || {};
