...
const resultSummary = computed(() => {
    ...
    if (!total) return "No email-channel notifications found";

    return `Showing ${from}-${to} of ${total} email notifications`;
});
...
const metricCards = computed(() => [
    {
        ...
        helper: "Notification records tagged as email",
    ...
    },
    {
        ...
        helper: "Unread email-notification records",
    ...
    },
    {
        ...
        helper: "Read email-notification records",
    ...
    },
    {
        ...
        helper: "Unique recipients reached",
...
const applyFilters = () => {
    router.get(route("superAdmin.massmailnotification"), buildQuery(), {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
const clearFilters = () => {
    ...
    router.get(route("superAdmin.massmailnotification"), {}, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
const deleteNotification = (row) => {
    Swal.fire({
        ...
        text: "This notification record will be permanently removed.",
        icon: "warning",
...
const deleteAll = () => {
    Swal.fire({
        title: "Delete all email notifications?",
        text: "This will remove all email-channel notifications in this view.",
        icon: "warning",
        showCancelButton: true,
...
<template>
    <AuthLayout title="Mass Mail Notifications" description="Review notification records sent through email channels">
