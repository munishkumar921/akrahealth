        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
         ...
         <Table :columns="columns" :data="{ data: paymentHistory }" :search="search">
            <template #actions="{ row }">
                <button class="btn btn-primary" @click="editPaymentDetails(row)"><i class="bi bi-pencil-square"></i></button>
             </template>
        </Table>
         <Modal :isOpen="isOpenModal" @close="closeAddPaymentModal" title="Add Payment" size="xl">
            ...
            <form @submit.prevent="addPayment" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <BaseInput type="number" v-model="form.payment"   id="paymentAmount" placeholder="Enter payment amount" required />
                ...
                <div class="mb-3">
                    ...
                    <BaseInput type="text" v-model="form.payment_type" id="paymentMethod" placeholder="Enter payment method" required />
                </div>
