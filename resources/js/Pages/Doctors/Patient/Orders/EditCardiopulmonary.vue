...
import CardiopulmonaryModal from '@/Pages/Modals/Cardiopulmonary.vue'
...
<form @submit.prevent="submitForm">
                        ...
                        <div class="iq-card-body p-4">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <BaseInput type="textarea" v-model="form.cp" label="Cardiopulmonary Test(s)" :type="'textarea'" placeholder="Cardiopulmonary Test(s)"
                                        @click="getDateMeta('orders_cp')" />
                                </div>
                                <div class="col-md-12 mt-3">
                                    <BaseTagsInput v-model="form.cp_icd" label="Diagnosis Codes"   placeholder="Type diagnosis codes"
                                    />
                                </div>
                                <div class="col-md-6 mt-3">
                                    <BaseSelect v-model="form.encounter_provider" label="Cardiopulmonary Provider">
                                        <option >
        ...
        <Modal  :isOpen="isCardiopulmonaryModalOpen" :title="'Add Cardiopulmonary Entry'" size="xl" @close="closeCardiopulmonaryModalOpen" >
            <CardiopulmonaryModal  :states="data.states" @close="closeCardiopulmonaryModalOpen"/>
        </Modal>
    </AuthLayout>
</template>
