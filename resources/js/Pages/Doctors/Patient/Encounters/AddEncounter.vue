...
const saveEncounter = () => {
    encounterForm.post(route('doctor.encounters.store'), {
        preserveState: true,
        preserveScroll: true,
        onSuccess: () => {
...
/* view form summery */
const saveEncounterDetailsBeforeSummary = () => {
    openEncounterSummary();
};

const openEncounterSummary = () => {
    isEncounterSummaryModalOpen.value = true;
};
...
<template>
<AuthLayout title="Add Encounter" description="Create a new patient encounter" heading="Add Encounter">
        <div class="my-4">
                ...
                <form @submit.prevent="saveEncounter">
                     <div class="mt-4">
                        ...
                        <div class="card mb-3" v-if="mainTab === 'Details'">
                            ...
                            <div class="card-body">
                                <EncounterDetails :encounterForm="encounterForm" :data="data" @save="saveAndProceed('SOAP')" />
                            </div>
                        </div>
