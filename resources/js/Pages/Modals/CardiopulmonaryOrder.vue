            ...
            <div class="modal-container" @click.stop>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Cardiopulmonary Order</h5>
                    ...
                    <form @submit.prevent="submit">
                        <div class="modal-body">
                            <div class="iq-card-body">
                                <div class="row mt-4">
                                    <div class="col">
                                        <label>Cardiopulmonary Test(s)</label>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col">
                                        <label>Cardiopulmonary Provider</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <DatePicker v-model="form.pending_date" type="date"
                                            placeholder="Order Pending Date" required />
