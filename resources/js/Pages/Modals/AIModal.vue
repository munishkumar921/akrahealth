...
<template>
    <section>
        <div class="modal fade" id="Ai-request-modal" size="lg" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 d-none d-lg-block">
                                    <div class="mt-3">
                                        <div class="row mt-2">
                                            <h6 class="bold display-6">Unlock It Now! <span
                                                    class="bold text-primary"><br>AI Receptionist Demo </span></h6>
                                            <p>Enter your details to explore AkraHealth's AI receptionist.</p>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-sm-6">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img class="w-50px" src="/images/svg/stronger-data-security.svg" />
                                                    <p class="mb-0">Healthcare Knowledge Base </p>
                                                </div>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img class="w-50px"
                                                        src="/images/svg/medication-e-prescription-management.svg" />
                                                    <p class="mb-0">Multiple Integrations </p>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img class="w-50px" src="/images/svg/ai-triage-management.svg" />
                                                    <p class="mb-0">AI Agent Console</p>
                                                </div>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img class="w-50px" src="/images/svg/integrated-services.svg" />
                                                    <p class="mb-0">Analytics & Reports </p>
                                                </div>
                                            </div>
