...
<template>
    <section>
        <div class="modal fade" id="white-lable-request-modal" size="lg" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 d-none d-lg-block">
                                    <div class="mt-3">
                                        <div class="row mt-2">
                                            <h6 class="bold display-6">White Label EMR<span
                                                    class="bold text-primary"> Unlock It Now!</span></h6>
