...
const update = (pharmacy) => {
    ...
    form.first_name = pharmacy?.user?.first_name || '';
    form.last_name = pharmacy?.user?.last_name || '';
    form.email = pharmacy?.user?.email || '';
    form.mobile = pharmacy?.user?.mobile || '';
    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <BaseFileInput v-model="form.banner" id="inputFileUpload" @change="onChangeFileUpload($event)"
                    accept="image/*" label="Banner Upload" placeholder="Upload Banner" :error="form.errors.banner" />
            </div>
            <div class="col-md-6 mb-3">
                <BaseInput v-model="form.pharmacy_name" label="Pharmacy Name" placeholder="Pharmacy Name" required
            ...
            <div class="col-md-6 mb-3">
                <BaseInput v-model="form.pharmacy_mobile" label="Pharmacy Mobile" type="number" placeholder="Pharmacy Mobile" required
                    :error="form.errors.pharmacy_mobile" />
            </div>
            <div class="col-md-6 mb-3">
                <BaseInput v-model="form.pharmacy_email" label="Pharmacy Email" placeholder="Pharmacy Email" required
                    :error="form.errors.pharmacy_email" />
            </div>
            <div class="col-md-6 mb-3">
