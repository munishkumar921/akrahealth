...
const submit = () => {
    ...
    form.post(route('demo-request.store'), {
        onSuccess: () => {
            ...
            setTimeout(() => {
                window.location.href = 'https://prescription.akrahealth.com/';
            }, 500);
            $('.close-modal').click();
        },
        onError: () => {
...
<template>
    <section>
        <div class="modal fade" id="prescription-request-modal" size="lg" tabindex="-1" role="dialog" aria-hidden="true">
