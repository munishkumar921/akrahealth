...
<template>
    <section>
        <div class="modal fade" id="emr-request-modal" size="lg" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    <img class="w-40px" src="/images/medical_&_social_history_.png" />
                                                    <p class="mb-0">Medical & Social History</p>
                                                </div>
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    <img class="w-40px" src="/images/svg/emr-lab-integration.webp" />
                                                    <p class="mb-0"> Forms & Templates</p>
                                                </div>
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    <img class="w-40px" src="/images/svg/emr-lab-integration.webp" />
