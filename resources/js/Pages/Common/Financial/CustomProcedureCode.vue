...
<template>
    <AuthLayout2 title="Custom Procedure Code Report" description="Generate custom procedure code reports"
        heading="Custom Procedure Code Report">
        <div class="row g-4">
                    ...
                    <div class="card-body p-4 p-xl-5">
                        <div class="section-heading mb-4">
                            ...
                            <p class="section-text mb-0">
                                Select the CPT or procedure code variables and years, then run the report or export it
                                to PDF.
                            </p>
                        </div>
                                ...
                                <div class="col-12 col-xl-6">
                                    <div class="filter-panel h-100">
                                        <div class="filter-panel-header">
                                            ...
                                            <div>
                                                <h4 class="filter-panel-title mb-1">Code Types</h4>
                                                <p class="filter-panel-text mb-0">
                                                    Pick one or more procedure code categories to include in the report.
                                                </p>
                                            </div>
                                        </div>

                                        <div class="mt-3">
                                            <BaseSelect v-model="form.variables" label="Variables (Code Types)"
                                                placeholder="Select one or more variables" multiple :required="true">
                                    ...
                                    <div class="filter-panel h-100">
                                        <div class="filter-panel-header">
                                            ...
                                            <div>
                                                ...
                                                <p class="filter-panel-text mb-0">
                                                    Select the financial years you want to include in this
