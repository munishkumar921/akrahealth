...
<template>
<AuthLayout2 title="Custom Payment Report" description="Generate custom payment reports" heading="Custom Payment Report">
        <div class="row">
                    ...
                    <form @submit.prevent="submit" novalidate class="needs-validation" :class="{ 'was-validated': isValidated }"> 
                        <div class=" justify-content-center">
                            <div class="col-md-5 mb-3">
                                <label class="form-label">Variables (Payment Types)</label>
                                <BaseSelect v-model="form.variables"  placeholder="Select one or more variables" multiple>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <BaseSelect v-model="form.year" placeholder="Select Year" required multiple>
