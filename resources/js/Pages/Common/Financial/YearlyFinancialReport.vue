...
const columns = [
    { label: "Year", key: "year_label", type: "slot", slot: "year", align: "left" },
...
const resultSummary = computed(() => {
    ...
    return `Showing ${from}-${to} of ${total} yearly report rows`;
});
</script>
...
<template>
    <AuthLayout2
        ...
        description="View yearly financial reports"
        heading="Yearly Financial Report"
    >
        <div class="row g-4">
                ...
                <div class="users-toolbar card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-3">
                            <div>
                                <h3 class="mb-1">Yearly Financial Report</h3>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-12 col-sm-6 col-xl-4">
                                ...
                                <div class="input-group yearly-search-control">
                                    ...
                                    <input
                                        ...
                                        placeholder="Search year or totals"
                    ...
                    <div class="card-body p-0 p-md-3">
                        <div class="d-flex justify-content-end align-items-center px-3 px-md-0 pt-3 pt-md-0 pb-2">
                            <div class="d-flex align-items-center gap-2 rows-select-wrap">
                                <label for="yearly-financial-per-page" class="text-muted small text-uppercase mb-0">Rows</label>
                                <select
                                    id="yearly-financial-per-page"
                                    v-model="perPage"
                        ...
                        >
                            <template #year="{ row }">
                                <div class="text-start">
                                    <div class="fw-semibold text-dark">{{ row.year_label || "-" }}</div>
                                </div>
                            </template>
