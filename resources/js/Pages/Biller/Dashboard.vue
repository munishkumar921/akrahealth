...
<template>
    <AuthLayout title="Biller Dashboard" description="Biller Dashboard">
        <div class="row">
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="value-box">
                                <h2 class="mb-0"><span class="counter">{{ dashboardData.messages || 0 }}</span></h2>
                            </div>
                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between bg-white rounded">
                        <div class="iq-header-title">
                            <h4 class="card-title">Biller Dashboard</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <div class="alert alert-info" role="alert">
                            <div class="iq-alert-text">Welcome to the Biller Dashboard. This is where you can manage billing operations.</div>
                        </div>
                    </div>
                </div>
            </div>
