...
<template>
    <AuthLayout :title="isUpgrade ? `Upgrade to ${plan?.title || 'Plan'}` : `Subscribe to ${plan?.title || 'Plan'}`"
        ...
        <div class="d-flex justify-content-end">
            <button @click="goBack" class="btn btn-primary" :disabled="loading">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                ...
                <!-- Upgrade Alert -->
                <div v-if="isUpgrade && !showSuccess" class="alert alert-info alert-dismissible fade show mb-4"
                    role="alert">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100" :class="{ 'border-success': isUpgrade }">
                            <div class="card-header"
                                :class="isUpgrade ? 'bg-success text-white' : 'bg-primary text-white'">
                                ...
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="text-muted">/{{ plan?.frequency?.toLowerCase() || 'mo'
                                                }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <ul v-if="planFeatures.length" class="list-unstyled mb-0">
                                                <li v-for="(feature, index) in planFeatures" :key="index"
                                                    ...
                                                    <i class="fas fa-check text-success me-2 mt-1 flex-shrink-0"
                                                        style="font-size: 0.875rem;"></i>
                                                    <span class="feature-text" style="font-size: 0.875rem;">{{ feature
                                                        }}</span>
                                                </li>
                                            </ul>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100" :class="{ 'border-warning': isExpiredSubscription }">
                            <div class="card-header"
                                :class="isExpiredSubscription ? 'bg-warning text-dark' : 'bg-secondary text-white'">
                                <h5 class="mb-0 text-white">
                            ...
                            <div class="card-body">
                                <div v-if="currentSubscription">
                                    <table class="table table-borderless mb-0">
                                        <tr>
                                            <td class="text-muted">Plan Name:</td>
                                            <td class="fw-bold">{{ currentSubscription.subscription_plan?.title ||
                                                upgradeFrom || 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge"
                                                    :class="currentSubscription.status === 'active' ? 'bg-success' : 'bg-warning'">
                                        ...
                                        <tr v-if="planExpiry && !isUpgrade">
                                            ...
                                            <td :class="planExpiry.isExpired ? 'text-danger fw-bold' : ''">
                                                {{ planExpiry.endDate }}
                                                <span v-if="planExpiry.isExpired"
                                                    class="badge bg-danger ms-2">Expired</span>
                                                <span v-else class="text-muted">({{ planExpiry.daysLeft }} days
                                                    left)</span>
                                            </td>
                                        </tr>
                                        <tr v-if="isUpgrade">
                                            ...
                                            <td class="text-danger fw-bold">
                                                {{ currentSubscription.end_date ? new
                                                    Date(currentSubscription.end_date).toLocaleDateString() : 'Unknown' }}
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div v-if="!showSuccess" class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            ...
                            <button @click="subscribe" class="btn" :class="isUpgrade ? 'btn-success' : 'btn-primary'"
                ...
                <div v-if="showSuccess" class="text-center">
                    ...
                    <button @click="router.visit(route('subscriptions.index'))" class="btn btn-primary me-2">
                        <i class="fas fa-list me-2"></i>
                        View My Subscription
                    </button>
                    <button @click="router.visit(route('dashboard'))" class="btn btn-secondary">
