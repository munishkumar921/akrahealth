...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\AllowClarityBot::class,
    ];
    ...
    protected $middlewareAliases = [
        ...
        'is.virtual.assistant' => \App\Http\Middleware\IsVirtualAssistant::class,
        'is.lab' => \App\Http\Middleware\IsLab::class,
        'is.pharmacy' => \App\Http\Middleware\IsPharmacy::class,
        'is.patient' => \App\Http\Middleware\IsPatient::class,
        'is.superAdmin' => \App\Http\Middleware\IsSuperAdmin::class,
        'is.biller' => \App\Http\Middleware\IsBiller::class,
